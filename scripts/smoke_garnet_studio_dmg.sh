...
record "pass" "Copied app executable assets exist" "app executable, bundled CLI, matrix script, PWA smoke" "None."
...
record "pass" "Copied app resource directories exist" "examples and docs" "None."
