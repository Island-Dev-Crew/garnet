...
class GithubActionsNode24ReadinessTests(unittest.TestCase):
    def test_first_party_actions_use_node24_capable_majors(self) -> None:
        failures: list[str] = []
        scanned = 0
        ...
        self.assertGreater(scanned, 0, "expected to scan at least one first-party workflow action")
