...
mkdir -p "${APP_DIR}/Contents/Resources/F_Project_Management/ROADMAPS"
mkdir -p "${APP_DIR}/Contents/Resources/garnet-parser-v0.3/benches"
mkdir -p "${APP_DIR}/Contents/Resources/garnet-interp-v0.3/benches"
mkdir -p "${APP_DIR}/Contents/Resources/garnet-memory-v0.3/benches"
...
cp "${ROOT}/scripts/garnet_benchmark_no_run.py" "${APP_DIR}/Contents/Resources/scripts/garnet_benchmark_no_run.py"
...
cp "${ROOT}/scripts/garnet_mit_deck_preview.py" "${APP_DIR}/Contents/Resources/scripts/garnet_mit_deck_preview.py"
...
cp "${ROOT}/scripts/garnet_proof_benchmark_status.py" "${APP_DIR}/Contents/Resources/scripts/garnet_proof_benchmark_status.py"
...
cp "${ROOT}/scripts/garnet_windows_linux_studio_status.py" "${APP_DIR}/Contents/Resources/scripts/garnet_windows_linux_studio_status.py"
...
cp "${ROOT}/F_Project_Management/ROADMAPS/GARNET_EMPIRICAL_VALIDATION_PLAN.md" "${APP_DIR}/Contents/Resources/F_Project_Management/ROADMAPS/GARNET_EMPIRICAL_VALIDATION_PLAN.md"
cp "${ROOT}/F_Project_Management/GARNET_v4_2_Developer_Comprehension_Study_Protocol.md" "${APP_DIR}/Contents/Resources/F_Project_Management/GARNET_v4_2_Developer_Comprehension_Study_Protocol.md"
cp "${ROOT}/F_Project_Management/GARNET_v4_0_PAPER_VI_EXECUTION.md" "${APP_DIR}/Contents/Resources/F_Project_Management/GARNET_v4_0_PAPER_VI_EXECUTION.md"
cp "${ROOT}/garnet-parser-v0.3/Cargo.toml" "${APP_DIR}/Contents/Resources/garnet-parser-v0.3/Cargo.toml"
cp "${ROOT}/garnet-parser-v0.3/benches/parse.rs" "${APP_DIR}/Contents/Resources/garnet-parser-v0.3/benches/parse.rs"
cp "${ROOT}/garnet-interp-v0.3/Cargo.toml" "${APP_DIR}/Contents/Resources/garnet-interp-v0.3/Cargo.toml"
cp "${ROOT}/garnet-interp-v0.3/benches/eval.rs" "${APP_DIR}/Contents/Resources/garnet-interp-v0.3/benches/eval.rs"
cp "${ROOT}/garnet-memory-v0.3/Cargo.toml" "${APP_DIR}/Contents/Resources/garnet-memory-v0.3/Cargo.toml"
cp "${ROOT}/garnet-memory-v0.3/benches/vector.rs" "${APP_DIR}/Contents/Resources/garnet-memory-v0.3/benches/vector.rs"
...
chmod 0755 "${APP_DIR}/Contents/Resources/scripts/garnet_benchmark_no_run.py"
...
chmod 0755 "${APP_DIR}/Contents/Resources/scripts/garnet_mit_deck_preview.py"
...
chmod 0755 "${APP_DIR}/Contents/Resources/scripts/garnet_proof_benchmark_status.py"
...
chmod 0755 "${APP_DIR}/Contents/Resources/scripts/garnet_windows_linux_studio_status.py"
