...
def probe_set(
    ...
    return [
        ...
        Probe(
            ...
            True,
            (
                "bidirectional-advisory-migration-surface",
                "proposed-gated",
                "javascript",
                "kotlin",
        ...
        Probe(
            "report-converter-llm-feasibility-provider-options",
            "converter LLM feasibility",
            "LLM feasibility reporter should expose provider choices without enabling provider-backed conversion",
            [sys.executable, str(ROOT / "scripts" / "garnet_converter_llm_feasibility.py"), "--format", "json"],
            True,
            (
                "\"provider_options\"",
        ...
        Probe(
            ...
            [
                ...
                (
                    ...
                    "'--output-dir', 'Bundle output:', 'Desktop', 'dogfood', "
        ...
        Probe(
            "report-proof-benchmark-status",
            "proof benchmark empirics",
            "Proof, benchmark, and empirical status should inventory current harnesses without claiming measurements or mechanized proof",
            [sys.executable, str(ROOT / "scripts" / "garnet_proof_benchmark_status.py"), "--format", "json"],
            True,
            (
                "\"overall_status\": \"active-scaffold\"",
                "\"measurement_status\": \"not-run\"",
                "\"mechanized_proof_status\": \"not-mechanized\"",
                "cargo bench -p garnet-parser --bench parse",
        ...
        Probe(
            ...
            "promo video readiness",
            "promo readiness status should lock visual identity and source surfaces before rendering",
            [sys.executable, str(ROOT / "scripts" / "garnet_promo_video_status.py"), "--format", "json"],
            True,
            (
        ...
        Probe(
            ...
            "promo video readiness",
            "promo readiness status should expose the repo-owned HyperFrames-compatible composition source",
            [sys.executable, str(ROOT / "scripts" / "garnet_promo_video_status.py"), "--format", "json"],
            True,
            (
                "\"composition_source_present\": true",
                "\"path\": \"docs/promo/composition.html\"",
                "\"design_contract_path\": \"docs/promo/DESIGN.md\"",
                "\"timeline_registered\": true",
                "\"tool\": \"hyperframes-html\"",
                "\"dogfood_probe_count\": 141",
