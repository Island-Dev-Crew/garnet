...
| Safe mode | Phase 4D active for direct use-after-move, direct mut-aliasing, `own self` method receiver moves, method receiver aliasing, simple typed receiver disambiguation, and simple field-place aliasing/field use-after-move; CapCaps already active | full index/dynamic place tracking, NLL/lifetime probes, generic/trait impl dispatch, drop discipline, and CapCaps bypass negatives active |
