...
| 8 | Phase 6 Memory Core | raises Memory Core from reference stores toward production-grade semantics | Phase 6A cycle fixtures active; next: production ARC allocator integration, machine-key isolation, tamper/privacy tests |
...
| Memory Core | Phase 6A bounded cycle fixtures active; stores remain reference implementations | production ARC allocator integration, finalization/safe-mode semantics, persistence/privacy, and machine-key isolation gates active |
