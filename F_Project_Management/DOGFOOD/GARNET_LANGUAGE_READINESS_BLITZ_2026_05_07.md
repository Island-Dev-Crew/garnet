...
| Safe mode | Phase 4A active for direct use-after-move and direct mut-aliasing conformance; CapCaps already active | full place-granular B1-B5, NLL/lifetime probes, method-call ownership, drop discipline, and CapCaps bypass negatives active |
