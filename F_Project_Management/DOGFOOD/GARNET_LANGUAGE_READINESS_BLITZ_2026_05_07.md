...
| 7 | Phase 5 traits/generics | prevents dynamic/trait claims from being parser-only | Phase 5A exact duplicate/orphan trait coherence active; generic overlap, generic instantiation, and dyn-trait check/run fixtures remain |
