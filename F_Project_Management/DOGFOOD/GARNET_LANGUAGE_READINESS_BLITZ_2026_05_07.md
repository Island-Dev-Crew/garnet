...
| Safe mode | Phase 4C active for direct use-after-move, direct mut-aliasing, `own self` method receiver moves, method receiver aliasing, and simple typed receiver disambiguation; CapCaps already active | full place-granular B1-B5, NLL/lifetime probes, generic/trait impl dispatch, drop discipline, and CapCaps bypass negatives active |
