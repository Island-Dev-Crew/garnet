...
| Safe mode | Phase 4B active for direct use-after-move, direct mut-aliasing, unambiguous `own self` method receiver moves, and method receiver aliasing; CapCaps already active | full place-granular B1-B5, NLL/lifetime probes, type-resolved method dispatch, drop discipline, and CapCaps bypass negatives active |
