...
| 5 | Phase 3 actors + Sendable | makes agent-native examples executable instead of Rust-runtime-only | Phase 3A nonsendable actor payload rejection active; actor syntax template smoke still pending |
