...
output mode to `garnet-parser-v0.3`. The AST stays the semantic reference;
...
- `garnet-parser-v0.3` — `--mode cst` flag (default remains AST); internal
  CST build via `rowan::GreenNodeBuilder`.
