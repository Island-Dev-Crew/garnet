...
| 4 Safe-mode ownership | `garnet-check-v0.3/src/borrow.rs`, `garnet-cli/tests/conformance_skeleton.rs` | Phase 4A active | full NLL/place-granular B1-B5 still pending | `cargo test -p garnet-cli --test conformance_skeleton partial_borrow_rule_suite` | full borrow/NLL checker handoff |
