...
| Agentic dogfood stress matrix | Active for audited agent-facing workflows | `scripts/run_agentic_dogfood_matrix.py --copy-to-desktop --strict`; Desktop bundle `/Users/idc2.0/Desktop/dogfood/garnet-agentic-dogfood-20260515-205403`; `F_Project_Management/DOGFOOD/GARNET_AGENTIC_DOGFOOD_STRESS_PLAN.md` | Add CI and Garnet Studio surface after keeping runtime cost and UX acceptable |
| Garnet Studio agentic matrix surface | Active for source-checkout app workflows | `swift run --package-path apps/garnet-studio-macos GarnetStudio --agentic-matrix-test`; Desktop bundle `/Users/idc2.0/Desktop/dogfood/garnet-agentic-dogfood-20260515-210445` | Decide whether to bundle offline matrix assets or keep this source-checkout-only for developer/MIT review builds |
