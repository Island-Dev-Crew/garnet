...
module-qualified/path const guard expressions or general expression evaluation. Function
...
top-level constants while preserving parameter/local/pattern shadowing. Module-
qualified/path const guard expressions and broad const evaluation remain
deferred.
