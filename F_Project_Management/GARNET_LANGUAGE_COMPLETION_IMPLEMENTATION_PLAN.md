...
| Agentic dogfood stress matrix | Active for audited agent-facing workflows, including packaged-app mode | `scripts/run_agentic_dogfood_matrix.py --copy-to-desktop --strict`; packaged-app Desktop bundle `/Users/idc2.0/Desktop/dogfood/garnet-agentic-dogfood-20260515-211707`; `F_Project_Management/DOGFOOD/GARNET_AGENTIC_DOGFOOD_STRESS_PLAN.md` | Add CI once runtime cost and environment assumptions are acceptable |
| Garnet Studio agentic matrix surface | Active for source-checkout, packaged app, mounted-DMG install-smoke, and notarization-preflight workflows | `swift run --package-path apps/garnet-studio-macos GarnetStudio --agentic-matrix-test`; `./scripts/package_garnet_studio_macos.sh`; `scripts/smoke_garnet_studio_dmg.sh target/macos/GarnetStudio.dmg`; `scripts/preflight_garnet_studio_notarization.sh --copy-to-desktop`; Desktop bundle `/Users/idc2.0/Desktop/dogfood/garnet-studio-notarization-preflight-20260515-213831` | Resolve Developer ID identity/profile/hardened-runtime blockers, then web/PWA and mobile gates as separate productization slices |
