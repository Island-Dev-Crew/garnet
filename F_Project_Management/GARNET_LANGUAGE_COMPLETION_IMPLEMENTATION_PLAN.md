...
| Promo video readiness contract | Active as composition-ready evidence for the future 30-second Garnet promo/ad lane | `scripts/garnet_promo_video_status.py`; `docs/promo/DESIGN.md`; `docs/promo/composition.html`; `python3 scripts/test_garnet_promo_video_status.py`; `scripts/run_agentic_dogfood_matrix.py` probes `report-promo-video-*` | Keep rendered MP4/WebM, visual QA, website export, Desktop dogfood evidence, and overclaim checks as required gates before claiming a shipped video |
...
`/Users/idc2.0/Desktop/dogfood/garnet-studio-dmg-smoke-20260516-065351` for
DMG SHA-256
`a27ad5afdda8efef1c0c092afbf30ca67f608c23278b3a354a1149d425a4074b`. This is
