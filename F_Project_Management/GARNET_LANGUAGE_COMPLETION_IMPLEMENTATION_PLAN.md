...
| Garnet web/PWA readiness | Active seed installable docs surface | `docs/manifest.webmanifest`; `docs/service-worker.js`; `scripts/smoke_garnet_web_pwa.sh --copy-to-desktop --strict`; `.github/workflows/web-pwa-readiness.yml` | Broaden beyond static docs into a richer web workbench only after the shell, offline cache, and Pages deployment smoke stay green |
