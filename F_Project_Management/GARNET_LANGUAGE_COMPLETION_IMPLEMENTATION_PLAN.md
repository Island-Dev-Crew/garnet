...
| Agentic dogfood stress matrix | Active for audited agent-facing workflows, packaged-app mode, and macOS CI artifact capture | `scripts/run_agentic_dogfood_matrix.py --copy-to-desktop --strict`; `.github/workflows/agentic-dogfood-matrix.yml`; Desktop bundle `/Users/idc2.0/Desktop/dogfood/garnet-agentic-dogfood-20260515-215847`; `F_Project_Management/DOGFOOD/GARNET_AGENTIC_DOGFOOD_STRESS_PLAN.md` | Keep local/Desktop and CI matrix evidence aligned; broaden only when new productization lanes have their own probes |
