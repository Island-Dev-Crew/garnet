...
arithmetic, non-integer/broader comparison, function-call, recursive, and
cross-file/package const evaluation.
...
guards as statically unreachable/non-covering, and leaves arithmetic,
non-integer/broader comparison, function-call, recursive, cross-file/package,
...
false/non-covering while keeping float arithmetic, non-finite floats, interpolated strings, ordering
