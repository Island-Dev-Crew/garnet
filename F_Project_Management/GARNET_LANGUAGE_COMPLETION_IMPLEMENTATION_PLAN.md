...
const aliases, broad const expression evaluation, or general expression evaluation. Function
parameters with the same name shadow the module const fact.
...
false/non-covering, while keeping ambiguous paths, const aliases, and broad
const expression evaluation conservative.
...
unreachable/non-covering, and keeps const aliases plus broad const expression
evaluation deferred.
