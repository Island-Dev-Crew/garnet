...
| §4 Memory | 3 | — | 6 | 1 | Phase 6M adds guarded append-style episodic text log commits on top of Phase 6L snapshot persistence/recovery, Phase 6K cycle-aware store-root lifecycles, and Phase 6J kind-aware allocator stats/policy eviction; production ARC allocator integration and broad production backends remain the largest Memory Core gaps. |
