...
| §11 User types | 2 | 2 | 4 | — | Generics and `dyn Trait` parse; `impl`, `@dynamic`, structural protocol semantics, and conservative trait coherence now have executable slices, but generic overlap solving and native monomorphization remain incomplete. |
