...
| §11.4 `impl` blocks | 🟡 | `ImplBlock` AST; `static_impl_dispatch_and_method_missing` | v0.5 Phase 2D registers inherent managed impl methods for struct instances. Trait impl coherence and generic impl resolution remain deferred. |
