...
| §7 Errors | 3 | — | — | — | Complete. |
| §8 Safe-mode | 1 | 1 | 2 | — | Phase 4K activates partial borrow-rule conformance, a conservative lifetime-elision subset for reference returns, B5 same-call drop discipline, first direct-return CFG-liveness slices, scoped loop-variable liveness, and scoped match-pattern liveness; full CFG NLL/lifetime inference and formal theorem stay paper-side. |
