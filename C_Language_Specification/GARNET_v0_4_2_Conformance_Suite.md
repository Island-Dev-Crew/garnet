...
| §11.8 structural protocol semantics | v0.5 Phase 2C/2E/2F | Runtime/Checker Gate | `deferred_structural_protocols`; `parses_protocol_cast_expression` | active pass, including arity, parameter-type, return-type, mode, and `as Protocol` cast negatives |
