...
| §6.3 full match exhaustiveness | v0.5 Phase 4P | Safe-Mode Gate | `deferred_match_exhaustiveness_and_reachability` | active partial pass for `Bool`, same-module enum subjects, finite nested-constructor payloads, scoped named/glob/module-qualified imported enum aliases, and literal guard reasoning; cross-file/package imports, recursive/open payload reasoning, open-domain literal reasoning, and non-literal guard reasoning remain deferred |
