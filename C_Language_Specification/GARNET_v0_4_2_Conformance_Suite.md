...
|---|---|---|---|
| §4.5 production ARC + Bacon-Rajan allocator integration | v0.5 Phase 6 | Memory Core Gate | active Phase 6A-6Q fixtures, including concrete `CycleAwareKindAllocator` root-release finalization and safe-affine exclusion evidence; production allocator-integrated ARC remains deferred |
