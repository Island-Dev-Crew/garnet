# Terminal freeze 3: F5 green after

## Boundary

- Execution and frozen head: `8659771c5a1828393d2e6ee54e1d679474b6e2ea`.
- Execution tree: `4347b6e31d9c681d9d715acd6452cf6cce281416`.
- State: post-rebind and post-producer, before the single custody commit.
- Accepted pair: `32f3975537470cb1788acfb3365725c4fea208a049e20fb90b1c314b719cba06 / 1637`.
...
|---|---:|---|---:|---|---|
| `python -I scripts/smoke_garnet_minimum_shelf.py --gate` | 0 | stdout | 2109 | `754235734873df5111d0e1c9fe19e7a25a8a026baac75ffda051f18b4ea238e4` | 1 CRLF |
| same | 0 | stderr | 0 | `e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855` | empty |
| `python -I scripts/garnet_wv_acceptance_status.py --wv WV-6 --gate` | 0 | stdout | 665 | `ee974d1e7f58152f68b63780ddb04c82d7b90af553c987b156ef56c06e338407` | 16 CRLF |
| same | 0 | stderr | 0 | `e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855` | empty |
...
```json
{
  ...
  "findings": [],
  "landed_main_sha": "8659771c5a1828393d2e6ee54e1d679474b6e2ea",
  "ok": true,
