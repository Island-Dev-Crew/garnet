...
Phase 4AT / 5C / 6P are the current readiness slices. Phases 1-3D added parser parity,
...
reasoning, interpolated strings, broader comparison, function-call, broader
