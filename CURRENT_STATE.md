...
Phase 4AI / 5C / 6P are the current readiness slices. Phases 1-3D added parser parity,
...
reasoning, const aliases, broader inference, and broader non-literal guard
