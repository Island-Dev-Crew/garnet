...
Phase 4S / 5C / 6P are the current readiness slices. Phases 1-3D added parser parity,
...
coverage and non-finite reassignment clears inferred finite-domain state. Full
CFG NLL region solving, branch-merged assignment flow, nested/non-local
