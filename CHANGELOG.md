...
### Scripts — retired words leave the reporters (2026-09-12)

- The retired vocabulary leaves 84 files under `scripts/` (purge PR-3b):
  docstring and smoke-test headings, comments, and local variable names. No
  JSON key, dataclass field or test name changes.
- The Paper VI scorecard moves with the reporters in the four documents that
  ...
  that pin it. Dated decision records, slice ledgers, archived proof
