...
- The Paper VI scorecard moves on both sides of every live pair: the five
  reporters and three tests that pin it, and the three companion documents
  their output is quoted from verbatim (`GARNET_v0_5_SLICE_DOGFOOD.md`,
  `GARNET_PROOF_MATRIX.md`, `GARNET_LLM_SUGGEST.md`). Dated records, archived
  proofs and this file's history keep the original wording.
